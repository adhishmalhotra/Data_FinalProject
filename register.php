...
<head>
    <meta charset="UTF-8">
    <title>Welcome to LinkedHub</title>
        ...
        <div class = "login_box">
            ...
            <div id="first"> 
                ...
                <form action = "register.php" method = "POST">
                    ...
                    <a href="#" id="signup" class="signup">Need an account? Register right here buddy!</a>
            ...
            <div id="second">
                <form action = "register.php" method = "POST">
                    ...
                    <br>
                    <?php if(in_array("<span style = 'color: #14C800;'> Account Created successfully! You can Login Now!</span> <br>", $error_array)) echo "<span style = 'color: #14C800;'> Account Created successfully! You can Login Now!</span> <br>"; ?>
                    <a href="#" id="signin" class="signin">Already have an account? Sign in right here buddy!</a>
                </form>
            </div>
        </div>
    </div>
